...
| [Interlace PDFs](media/interlace/) | Rebuild a double-sided scan from its two halves: pages come out A1, B1, A2, B2, … Reverse or flip a side the feeder got the wrong way round, reorder pages, then save. Pages are copied as they are, links and bookmarks kept. |
