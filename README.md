...
| [Interlace PDFs](media/interlace/) | Merge two PDFs page by page (A1, B1, A2, B2, …), for the two halves of a double-sided scan. Reverse either side, then drag pages around or drop them before saving. Pages are copied without re-rendering; internal links, bookmarks and form fields are kept. |
